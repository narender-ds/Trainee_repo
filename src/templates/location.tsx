...
const Location: Template<ExternalApiRenderData> = ({
  ...
  console.log("fffo,kooloo,.ol",c_allMenuItem)
      ...
      >
        ...
        <AnalyticsScopeProvider name={""}>
          <PageLayout global={_site}>
            ...
            <BannerSlide BackgroundImage={c_bannerPhoto} title={c_titleForBanner} c_cTAForBanner={c_cTAForBanner} c_bannerSlogan={c_bannerSlogan} />
            ...
            <div className="nearby-sec">
              <div className="container">
                ...
                <PhotoSlider photoGallery={c_photoForDetail} PhotoGallarytitle={c_titleForPhotoGallery}/>
                
                <div className="mt-[80px] ">
                  <Services c_menuitems={c_allMenuItem} title={c_titleForAllMenus}/>
                  
                </div>
                <About c_aboutData={c_surveyDescription} photo={c_surveyPhoto} title={c_surveyTitle}  Cta={c_cTAForSurvey} />
                ...
                <div className="mt-[90px]">
                  <FaqAccordian Question={c_faqRelation} />
                </div>
