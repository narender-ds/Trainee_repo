...
const Footer = (props: DataOfProps) => {
  ...
  return (
    ...
    //   </div>
    // </footer>
    <footer className=" bg-[#007a53]  text-white">
      <div className="container px-6 pt-6">
        <div className="">
          <div className=" grid lg:grid-cols-4 md:grid-cols-2">
            <div className="Footer-navList">
              <h4 style={{fontWeight:"bold",color:"black"}}>{FooterData.ourCompany}</h4>
            ...
            <div className="Footer-navList">
              <h4 style={{fontWeight:"bold",color:"black"}}> {FooterData.foodTitle}</h4>
            ...
            <div className="Footer-navList">
              <h4 style={{fontWeight:"bold",color:"black"}}>{FooterData.helpTitle}</h4>
